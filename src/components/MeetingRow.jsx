...
import { formatTime, nextOccurrence, startsInLabel, relativeDayLabel } from "@/lib/meetings";
  ...
  return (
    ...
    >
      ...
      <div className="flex w-[68px] shrink-0 flex-col items-start">
        ...
        {isVirtual ? (
          ...
          <span className="mt-1 text-xs text-muted-foreground">
            {meeting.distance != null ? `${meeting.distance} mi` : ""}
          </span>
        )}
      </div>
      ...
      <div className="min-w-0 flex-1">
        ...
        <p className="truncate text-sm text-muted-foreground">
          {meeting.city ? `${meeting.city}, ${meeting.state}` : meeting.virtual_platform}
        </p>
        {startsIn && (
